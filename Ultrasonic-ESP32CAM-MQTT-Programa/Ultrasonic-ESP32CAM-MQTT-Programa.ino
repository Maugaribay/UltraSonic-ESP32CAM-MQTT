...
/*
 * Lectura del sensor ultasonico HC-SR04 con el ESP32CM y MQTT
 * por: Mauricio Garibay
 * Fecha: 1 de Octubre de 2021
 * 
 * Este programa lee el sensor ultrasonico con la Biblioteca Ulrasonic de Erick Simoes
 * en su version 3.0.0. Se mezcla con el programa ESP32CAM-MQTT-basic del repositorio
 * de Codigo-IoT
 * 
...
//Datos de WiFi
const char* ssid = "INFINITUM3E85";  // Aquí debes poner el nombre de tu red
const char* password = "Rp7Yu2Sq8n";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "127.0.0.0.233"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
